...
5. Keep specifications as a flat object with string values.
6. Keep complianceFlags as an array of strings.
7. If an optional field is not present, return an empty value according to the schema.
8. Return only the requested structured JSON object.
