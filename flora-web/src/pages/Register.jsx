...
export const Register = () => {
  const { register, googleOAuth, githubOAuth, getOAuthConfig } = useAuth();
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 font-sans text-brand-text">
      <div className="max-w-md w-full bg-surface border border-brand-border rounded-xl shadow-lg p-8 space-y-6 animate-fade-in-up text-left">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-extrabold text-brand-text tracking-tight">Create Account</h1>
          <p className="text-xs text-brand-muted">Get started with FLORA Product Intelligence Platform</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
          <div>
            <label className="font-semibold text-brand-secondary block mb-1">Full Name</label>
            <input
              type="text"
              required
          ...
          <div>
            <label className="font-semibold text-brand-secondary block mb-1">Password</label>
            <input
              type="password"
              required
              placeholder="••••••••"
          ...
          <div>
            <label className="font-semibold text-brand-secondary block mb-1">Confirm Password</label>
            <input
              type="password"
              required
              placeholder="••••••••"
